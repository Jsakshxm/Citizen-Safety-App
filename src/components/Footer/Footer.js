        ...
        <div className="container mx-auto px-4">
            <div className="flex flex-wrap justify-between">
                <div className="w-full md:w-1/3 lg:w-1/4 mb-4 md:mb-0">
                    <h2 className="text-white text-lg font-semibold mb-4">Online Fraud Detection and Education</h2>
                    <p className="text-gray-400">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed quis justo vitae urna tincidunt cursus.</p>
                </div>
                <div className="w-full md:w-1/3 lg:w-1/4 mb-4 md:mb-0">
                ...
                <div className="w-full md:w-1/3 lg:w-1/4 mb-4 md:mb-0">
                    ...
                    <ul className="text-gray-400">
                        ...
                        <li className="mb-2"><a href="#" className="hover:text-gray-200">About</a></li>
                        <li className="mb-2"><a href="#" className="hover:text-gray-200">Services</a></li>
                        <li className="mb-2"><a href="#" className="hover:text-gray-200">Contact</a></li>
                    </ul>
                </div>
            </div>
            <div className="mt-8">
